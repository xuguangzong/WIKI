...
from wiki.models import Article, Category, Tag, SideBar, Links
from django.contrib.auth import get_user_model
from DjangoWiki.utils import get_current_site, get_md5
from wiki.forms import WikiSearchForm
from django.core.paginator import Paginator
from wiki.templatetags.wiki_tags import load_pagination_info, load_articletags
...
class ArticleTest(TestCase):
    ...
    def test_validate_article(self):
        ...
        response = self.client.get(reverse('wiki:archives'))
        self.assertEqual(response.status_code, 200)
    ...
    def test_image(self):
        ...
        with open(imagepath, 'rb') as file:
            ...
            self.assertEqual(rsp.status_code, 200)
        from DjangoWiki.utils import save_user_avatar, send_email
