...
from DjangoWiki.utils import cache, get_md5, get_wiki_setting
from django.shortcuts import get_object_or_404
from wiki.models import Article, Category, Tag, Links, LinkShowType
...
class ArticleListView(ListView):
    ...
    template_name = 'wiki/article_index.html'
...
class ArchivesView(ArticleListView):
    ...
    paginate_by = None
    page_kwarg = None
    template_name = 'wiki/article_archives.html'
...
class LinkListView(ListView):
    model = Links
    template_name = 'wiki/links_list.html'
...
def page_not_found_view(
        request,
        exception,
        template_name='wiki/error_page.html'):
    if exception:
...
def server_error_view(request, template_name='wiki/error_page.html'):
    return render(request,
                  template_name,
