...
from DjangoWiki.utils import cache, send_email, expire_view_cache, delete_sidebar_cache, delete_view_cache
from DjangoWiki.spider_notify import SpiderNotify
from oauth.models import OAuthUser
from wiki.models import Article, Category, Tag, Links, SideBar, WikiSettings
...
def oauth_user_login_signal_handler(sender, **kwargs):
    ...
    if oauthuser.picture and not oauthuser.picture.find(site) >= 0:
        from DjangoWiki.utils import save_user_avatar
